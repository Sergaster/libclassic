...
bool ccl_vector_push_tail(ccl_vector *, void *);
bool ccl_vector_pop_tail(ccl_vector *, void **);
bool ccl_vector_push_head(ccl_vector *, void *);
bool ccl_vector_pop_head(ccl_vector *, void **);
