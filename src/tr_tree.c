...
int ccl_trtree_insert(ccl_trtree *tree, void *k, void *v, void **pv)
{
...
int ccl_trtree_delete(ccl_trtree *tree, void *key)
{
	void *k, *v;
...
ccl_map *ccl_map_trtree(ccl_cmp_cb cmp_cb, ccl_free_cb kfree_cb, ccl_free_cb vfree_cb, ccl_prio_cb prio_cb)
{
	ccl_map *map;
